...
/**
 * Refer to : https://www.hackerrank.com/challenges/minimum-average-waiting-time
 * This solution uses a priority queue.
 */
public class MinAvgWaitTime {
    ...
    public static class Customer {
        ...
        public enum Order implements Comparator<Customer> {
            ByT() {
